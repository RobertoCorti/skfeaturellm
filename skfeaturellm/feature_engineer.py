...
class LLMFeatureEngineer(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X: pd.DataFrame, y: Optional[pd.Series] = None) -> "LLMFeatureEngineer":
        """
        ...
        llm_interface.generate_feature_ideas(X, self.target_col, self.max_features)
        self.generated_features = llm_interface.generated_features
